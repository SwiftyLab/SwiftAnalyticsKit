...
final class MultiplexAnalyticsHandlerTests: XCTestCase {
    ...
    func testMultiplexHandler() throws {
        ...
        let actionHandler = AnalyticsOrderedExpectationHandler<String>()
        let actionHandler2 = AnalyticsOrderedExpectationHandler<String>()
        let stateHandler = AnalyticsOrderedExpectationHandler<String>()
        ...
        mHandler.register(handler: actionStateHandler, for: [.action, .state])
